    ...
    <DashboardLayout userRole="owner">
      <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/5">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
          {/* Header */}
          <div className="mb-6">
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">Discover Clients</h1>
            <p className="text-sm sm:text-base text-muted-foreground">Swipe to find your perfect tenants</p>
          </div>
