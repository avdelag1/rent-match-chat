...
export function TopBar({ onNotificationsClick, onSettingsClick, onFiltersClick, className, showFilters = false }: TopBarProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between h-11 px-6 max-w-screen-xl mx-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {notificationCount > 0 && (
              <span className="absolute -top-1 -right-1 bg-destructive text-destructive-foreground text-[10px] font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center shadow-lg border-2 border-background">
