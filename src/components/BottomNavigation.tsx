...
export function BottomNavigation({ userRole, onFilterClick, onAddListingClick, onListingsClick }: BottomNavigationProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center gap-4 px-4 py-2.5 pointer-events-auto bg-background/90 backdrop-blur-xl rounded-2xl border border-border/30 shadow-2xl mx-auto max-w-fit mb-1">
        {navItems.map((item) => {
