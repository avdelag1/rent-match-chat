...
export function ClientTinderSwipeCard({
  ...
  return (
    ...
    >
      <Card className="relative w-full h-[calc(100vh-260px)] max-h-[680px] overflow-hidden bg-card/95 backdrop-blur-2xl border-none shadow-card rounded-3xl" style={{ willChange: 'transform', transform: 'translateZ(0)' }}>
        {/* Swipe Overlays */}
