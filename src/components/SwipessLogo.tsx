  ...
  return (
    <span
      className={cn(
        ...
        'bg-gradient-to-r from-orange-300 via-red-400 to-orange-300 bg-clip-text text-transparent',
        'drop-shadow-[0_0_20px_rgba(253,186,116,1)] [filter:drop-shadow(0_0_12px_rgba(253,186,116,0.9))]',
        '[text-shadow:0_0_30px_rgba(253,186,116,0.8)]',
        sizeClasses[size],
        className
      )}
    >
