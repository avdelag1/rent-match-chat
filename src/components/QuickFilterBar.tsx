...
import { Home, Car, Bike, Ship, RotateCcw } from 'lucide-react';
...
function QuickFilterBarComponent({ filters, onChange, className }: QuickFilterBarProps) {
  ...
  const hasActiveFilters = filters.categories.length > 0 || filters.listingType !== 'both';
          ...
          {hasActiveFilters && (
            ...
            >
              <p className="text-[10px] text-muted-foreground">
                Showing: {filters.categories.length > 0
