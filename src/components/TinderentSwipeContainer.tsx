          ...
          <div className="flex justify-center items-center gap-8 py-4 px-4 max-w-xl mx-auto">
            ...
            >
              <Button
                size="lg"
                variant="ghost"
                className="w-16 h-16 rounded-full bg-gradient-to-br from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white transition-all duration-300 shadow-xl p-0 border-0"
            ...
            >
              <Button
                size="lg"
                variant="ghost"
                className="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white transition-all duration-300 shadow-xl p-0 border-0"
