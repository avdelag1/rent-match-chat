-- ================================================================
-- CREATE 2 TEST USERS - Use 'welcome' activation type
-- ================================================================
...
BEGIN
    ...
    INSERT INTO public.message_activations (user_id, activation_type, total_activations, used_activations, expires_at, created_at, updated_at)
    VALUES (user1_id, 'welcome', 5, 0, NOW() + INTERVAL '90 days', NOW(), NOW());
    ...
    INSERT INTO public.message_activations (user_id, activation_type, total_activations, used_activations, expires_at, created_at, updated_at)
    VALUES (user2_id, 'welcome', 5, 0, NOW() + INTERVAL '90 days', NOW(), NOW());

    RAISE NOTICE '✅ DONE!';
    RAISE NOTICE 'test1@zwipes.com / TestPass123!';
    RAISE NOTICE 'test2@zwipes.com / TestPass123!';
END $$;
...
BEGIN
    ...
    INSERT INTO public.message_activations (user_id, activation_type, total_activations, used_activations, expires_at, created_at, updated_at)
    VALUES (NEW.id, 'welcome', 1, 0, NOW() + INTERVAL '90 days', NOW(), NOW())
...
SELECT '🎉 SUCCESS! Go sign in now!' AS status;
