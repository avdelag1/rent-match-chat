-- ================================================================
-- CREATE 2 TEST USERS - FINAL WORKING VERSION
-- ================================================================
...
BEGIN
    ...
    VALUES (user1_id, 'referral_bonus', 5, 0, NOW() + INTERVAL '90 days', NOW(), NOW());
    ...
    INSERT INTO public.message_activations (user_id, activation_type, total_activations, used_activations, expires_at, created_at, updated_at)
    VALUES (user2_id, 'referral_bonus', 5, 0, NOW() + INTERVAL '90 days', NOW(), NOW());
...
BEGIN
    ...
    INSERT INTO public.message_activations (user_id, activation_type, total_activations, used_activations, expires_at, created_at, updated_at)
    VALUES (NEW.id, 'referral_bonus', 1, 0, NOW() + INTERVAL '90 days', NOW(), NOW())
