-- ================================================================
-- CREATE 2 TEST USERS - Skip message_activations (broken constraint)
-- ================================================================
...
BEGIN
    ...
    RAISE NOTICE '✅ SUCCESS! Users created (no message activations due to broken constraint)';
    RAISE NOTICE 'test1@zwipes.com / TestPass123! (CLIENT)';
    RAISE NOTICE 'test2@zwipes.com / TestPass123! (OWNER)';
    RAISE NOTICE 'You can now sign in and test the app!';
END $$;

-- Recreate trigger WITHOUT message_activations (it has a broken check constraint)
...
BEGIN
    ...
    -- Skip message_activations (broken check constraint)
