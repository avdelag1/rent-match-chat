-- =============================================================================
-- STEP 1: Fix conversations table schema (SAFE VERSION)
-- Run this FIRST in a single transaction
-- =============================================================================

-- Main migration logic (columns, data migration, policies)
DO $$
DECLARE
...
-- Update RLS policies (wrapped in transaction for atomicity)
BEGIN;
...
-- Update unique conversation constraint (separate transaction)
DO $$
BEGIN
  IF EXISTS (
