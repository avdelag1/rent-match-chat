-- Add location columns to profiles table for better geolocation support
...
-- Function to find nearby profiles within a radius
...
-- Function to find nearby listings within a radius
