-- Create delete_user_account_data RPC function with cascade delete for all user data
-- NOTE: This function only deletes related user data, NOT the auth user itself
-- The auth user must be deleted using Supabase Admin API via the delete-user edge function
